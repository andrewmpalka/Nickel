...
let alertConst = UIAlertController(title: "Verifying your Apple ID...", message: "this may take a moment depending on connection", preferredStyle: UIAlertControllerStyle.ActionSheet)
